...
def parse_arguments():
    ...
    parser.add_argument(
        "--learning_rate", type=float, default=0.0001, help="Batch size"
    )
    parser.add_argument(
        "--batch_size", type=int, default=2 * 10**3, help="Batch size"
    )
...
if __name__ == "__main__":
    print("This is a module for parsing arguments for the rcnn model.")
